...
const Button = ({ 
  ...
  const variants = {
    ...
    dark: "bg-brand-dark text-white border border-brand-accent/30 shadow-lg shadow-brand-dark/30 hover:bg-brand-dark/90 hover:border-brand-accent transform hover:-translate-y-1 active:scale-95",
  };
